...
const topicChangeRequestsRouter = require('./domains/topic-change-requests/topic-change-requests.router');
...
const peerEvaluationsRouter = require('./domains/peer-evaluations/peer-evaluations.router');
...
app.use('/api/v1/topic-change-requests', topicChangeRequestsRouter);
...
app.use('/api/v1/peer-evaluations', peerEvaluationsRouter);
